...
(async() => {
    ...
    /* */
    const mainCameraRotationX = Math.PI * -.1;

    /* */
    const firstPersonCameraRotationX = 0;
    ...
    camera.rotation.x = mainCameraRotationX;
    ...
    /* Material de los textos de plazas libres en función del % de plazas ocupadas */
    ...
    /* Creación de los objetos para textos de plazas libres */
    ...
    /* Creación de los objetos parking*/
    ...
    new MTLLoader().load('./assets/Car.mtl', (materials) => {
        ...
        new OBJLoader().setMaterials(materials).load('./assets/Car.obj', (object) => {
            car = object;
            car.scale.set(carSize.x, carSize.y, carSize.z);
    ...
    /* Controlador de colisiones entre vehiculo y parkings*/
    ...
    const cameraController = () => {
        if(selectedCamera === CameraType.FirstPersonCamera) {
            ...
            camera.rotation.x = firstPersonCameraRotationX;
        }
    };

    /* Controlador de parkings */
    ...
    const animate = () => {
        /* Solicita que el navegador programe 
        el repintado de la ventana para el 
        próximo ciclo de animación */
